...
const Navbar = () => {
  ...
  return (
    <header className="bg-main-secondary-bg sticky top-0 w-full p-2 py-4 z-[10000]">
      ...
      <nav className="flex justify-between items-center h-9">
        <div className="flex items-center gap-4 sidebar:w-1/2 sidebar:justify-between">
          ...
          />
          <Link to="/">
            <IconWrapper className="p-1 w-11 h-11 border-0 sidebar:w-13 sidebar:h-13">
              <Logo id="navbar-logo" />
            </IconWrapper>
          </Link>
        ...
        <div className="flex items-center gap-4 h-full">
          ...
          <Link to="/basket">
            <IconWrapper
              className="p-2 border border-main-primary-text rounded-small"
              hasHoverEffect
            >
