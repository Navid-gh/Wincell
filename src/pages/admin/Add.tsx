    ...
    if (parent === 'articles') {
        ...
        return (
            <div className='flex flex-col gap-6'>
                ...
                <input type='text' placeholder='متنی کوتاه برای نمایش در کنار سر تیتر' ref={shortTextRef} />
                ...
                <textarea placeholder='مقاله ی خود را در فرمت مارکداون بنویسید' cols={30} rows={10} ref={textRef}></textarea>
        ...
        return (
            <div className='flex flex-col gap-6'>
                ...
                <input type='text' placeholder='title' ref={titleRef} />
                <input type='text' placeholder='متنی کوتاه برای نمایش در کنار سر تیتر' ref={shortTextRef} />
                <textarea placeholder='توضیحات دوره خود را در فرمت مارکداون بنویسید' cols={30} rows={10} ref={textRef}></textarea>
                ...
                <input type='text' placeholder='زمان مورد نیاز دوره به صورت ساعت:دقیقه' ref={neededTimeRef} />
                <input type='text' placeholder='نام برگزار کننده ' ref={ownerNameRef} />
                <input type='text' placeholder='لوگو برگذار کننده ' ref={ownerLogoRef} />
                <input type='text' placeholder='متن پیش نیاز' ref={prerequisitesTxtRef} />
                <input type='text' placeholder='آیدی دوره های پیش نیاز به صورت جداشده با کاما' ref={prerequisitesRef} />
