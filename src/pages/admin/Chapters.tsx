  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        ...
        <input
          type="text"
          placeholder="ساعت و دقیقه برای مثال به صورت 1:41"
          ref={timeRef}
        />
        <button
      ...
      <div className="flex flex-col gap-3">
        ...
        <input
          type="text"
          placeholder="ثانیه و دقیقه برای مثال به صورت 20:56"
          ref={episodeTimeRef}
        />
        <button
          className="max-w-fit bg-pink"
      ...
      <ul className="flex flex-col gap-4">
        {chaptersState?.map(({ _id, episodes, time, title }, idx) => (
          <li key={_id} className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                onClick={() => removeChapterMutation.mutate(_id)}
              >
                حذف فصل
              </button>
            </div>
